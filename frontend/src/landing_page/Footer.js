        ...
        <div className='container border-top mt-5 bg-light'>
            <div className='row mt-5'>
                ...
                <div className='col'>
                    ...
                    <a href="" style={{textDecoration:"none", color:"black"}}>Products</a><br></br>
                    <a href="" style={{textDecoration:"none", color:"black"}}>Pricing</a><br></br>
                    <a href="" style={{textDecoration:"none", color:"black"}}>Referral programs</a><br></br>
                    <a href="" style={{textDecoration:"none", color:"black"}}>Careers</a><br></br>
                    <a href="" style={{textDecoration:"none", color:"black"}}>Xerodha.tech</a><br></br>
                    <a href="" style={{textDecoration:"none", color:"black"}}>Press & media</a><br></br>
                    <a href="" style={{textDecoration:"none", color:"black"}}>Zerodha cares</a><br></br>
                </div>
                <div className='col'>
                    <p>Support</p>
                    ...
                    <a href="" style={{textDecoration:"none", color:"black"}}>List of charges</a><br></br>
                    <a href="" style={{textDecoration:"none", color:"black"}}>Downloads and resources</a><br></br>
                    <a href="" style={{textDecoration:"none", color:"black"}}>Videos</a><br></br>
                    <a href="" style={{textDecoration:"none", color:"black"}}>Market overview</a><br></br>
                ...
                <div className='col'>
                    <p>Account</p>
                    <a href="" style={{textDecoration:"none", color:"black"}}>Open an account</a><br></br>
